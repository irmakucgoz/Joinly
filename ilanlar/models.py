...
from django.conf import settings # Yeni kullanıcı adresini buradan alacağız
from django.db import models

# 1. KATEGORİ TABLOSU
class Category(models.Model):
    name = models.CharField(max_length=50, verbose_name="Kategori Adı")
    color = models.CharField(max_length=7, default="#007bff", verbose_name="Kategori Rengi")  # Hex color code
...
class Message(models.Model):
    ...
    def __str__(self):
        return f"{self.sender} -> {self.receiver} (İlan: {self.ad.title})"

# 4. DEĞERLENDİRME (REVIEW) TABLOSU
